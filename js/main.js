...
$(function() {
  ...
  // active menu in startup
    ...
    menu.forEach(function(item) {
      ...
      else if (page == 'Thankyou') document.querySelector('.art-current-page').textContent = "Thank You";
    });
...
*/
  ...
  // slider previous commissions
  var swiper = new Swiper('.commissions-slider', {
    slidesPerView: 4,
    spaceBetween: 30,
    speed: 1400,
    autoplay: true,
    autoplaySpeed: 5000,
    pagination: {
      el: '.swiper-commissions-pagination',
      clickable: true,
    },
    navigation: {
      nextEl: '.commissions-swiper-next',
      prevEl: '.commissions-swiper-prev',
    },
    breakpoints: {
      1500: {
        slidesPerView: 4,
